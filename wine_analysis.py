...
# MAGIC 
# MAGIC     **Note**: if you don't have the *Data* > *Add Data* option, you can load the dataset from the Databricks example datasets. Uncomment and run the last two lines in the following cell.
# MAGIC 
...
# If you have the Data > Add Data sidebar menu option, follow the instructions in the previous cell to upload the data from your local machine.
...
# If you do not have the Data > Add Data menu option, uncomment and run these lines to load the dataset.
...
table_path = "dbfs:/FileStore/patricia/delta/wine_data"
